...
export const portfolio = {
  ...
  projects: [
    ...
    },
    {
      ...
      summary:
        "A milestone-based ASP.NET Core MVC application for organising job opportunities and building a more deliberate application workflow.",
      contribution:
        "Built the .NET 10 and ASP.NET Core MVC foundation with responsive views, automated tests and GitHub Actions quality checks. Documented requirements and security boundaries, with authentication, PostgreSQL storage and deployment planned as later milestones.",
      employerSignal:
        "Shows structured delivery, honest scoping of work in progress, security-aware planning and the discipline to establish automated quality checks early in a project.",
      technologies: [".NET 10", "ASP.NET Core MVC", "C#", "GitHub Actions"],
      highlights: [
        "Responsive application views",
